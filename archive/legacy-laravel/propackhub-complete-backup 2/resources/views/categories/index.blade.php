                        ...
                        <table id="userTable" class="w-full table-auto border-collapse text-sm text-left text-gray-700">
                            <thead class="bg-gray-200 text-gray-800">
                                <tr>
                                    ...
                                    <th class="px-6 py-3 font-medium uppercase text-white">Category Name</th>
                            ...
                            <tbody>
                                ...
                                @foreach ($categories as $record)
                                    <tr class="border-b hover:bg-gray-100">
                                        ...
                                        <td class="px-6 py-4">{{ $record->category_name }}</td>
                                        <td class="px-6 py-4">
                                            <div class="flex items-center space-x-4">
                                                <!-- Edit Button -->
                                                <a href="{{ route('categories.edit', $record->id) }}" class="text-green-600 hover:text-green-800">
                                                ...
                                                <!-- Delete Form (Hidden) -->
                                                <form id="delete-form-{{ $record->id }}" action="{{ route('categories.destroy', $record->id) }}" method="POST" style="display: none;">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
                                            </div>
