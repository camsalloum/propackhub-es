...
<section class="hero-one">
   <div class="container-fluid full-wid">
      <div class="top-btns d-flex justify-content-center mb-3">
        <button class="btn btn-save btn-before" name="submitButton" value="update" form="mainForm" type="submit">Update</button>
        <button class="btn btn-save btn-before" name="submitButton" value="duplicate" form="mainForm" type="submit">Duplicate</button>
      </div>
      @if(session('success'))
         ...
         <div class="container-fluid">
            ...
            <div class="form_one customer-name">
               <div class="form-group">
                  ...
                  <input type="text" class="form-control" form="mainForm" value="{{$record->customerName}}" id="customerName" name="customerName">
               </div>
               <div class="form-group job-name">
                  <label for="jobName" class="form-label">Job Name</label>
                  <input type="text" class="form-control" form="mainForm" value="{{$record->jobName}}" id="jobName" name="jobName">
               </div>
               ...
               <div class="form-group product-number">
                    ...
                    <input type="text" class="form-control" value="{{$record->projectNumber}}" form="mainForm" id="projectNumber" name="projectNumber" style="text-align: center;">
                </div>
               <div class="form-group order-quantity">
                  <label for="orderQuantity" class="form-label">Order Quantity</label>
                  <div class="input-group">
                     <input type="text" class="form-control orderQuantity" value="{{$record->orderQuantity}}" form="mainForm" id="orderQuantity" name="orderQuantity" oninput="formatNumberWithCommas(this)">
                     ...
                     <option value="Roll 500 LM" {{ $record->units == 'Roll 500 LM' ? 'selected' : '' }}>Roll 500 LM</option>
                     </select>
                  </div>
               </div>
               <div class="form-group date-pick">
                    ...
                    value="{{ $record->project_date ? \Carbon\Carbon::createFromFormat('m/d/Y', $record->project_date)->format('Y-m-d') : '' }}" 
                    form="mainForm" id="project_date" name="project_date">
                </div>

            </div>
         </div>
         <div style="background: #EEF8FF;" class="py-4 mt-3">
   <div class="container-fluid">
      <!-- Roll Table -->
      <div class="table-responsive result-tables roll-table" id="roll-table">
         <table class="table table-bordered myTable">
            ...
            <tbody>
               <tr>
                  <td>Reel Width (mm)</td>
                  <td class="has-input "><input id="roll-real-width" form="mainForm" name="roll-real-width" type="number"  oninput="validateDecimalInput(this)" value="{{ $record->secondary['roll-real-width'] !== '' ? $record->secondary['roll-real-width'] : '0.00' }}" class="blue-field roll-real-width"></td>
               </tr>
               <tr>
                  <td>Cut Off (mm)</td>
                  <td class="has-input"><input id="roll-cut-off" form="mainForm" oninput="validateDecimalInput(this)" name="roll-cut-off" type="number" value="{{ $record->secondary['roll-cut-off'] !== '' ? $record->secondary['roll-cut-off'] : '0.00' }}" class="blue-field roll-cut-off"></td>
               </tr>
               <tr>
                  <td>Extra Printing Trim (mm)</td>
                  <td class="has-input"><input id="roll-extra-printing-trim" form="mainForm" name="roll-extra-printing-trim" type="number" value="{{ $record->secondary['roll-extra-printing-trim'] !== '' ? $record->secondary['roll-extra-printing-trim'] : '0' }}" class="blue-field roll-extra-printing-trim"></td>
               </tr>
               <tr>
                  <td>Pieces per Cut</td>
                  <td class="has-input"><input form="mainForm" name="roll-pieces-per-cut" id="roll-pieces-per-cut" type="number" value="{{ $record->secondary['roll-pieces-per-cut'] !== '' ? $record->secondary['roll-pieces-per-cut'] : '0' }}" class="blue-field roll-pieces-per-cut"></td>
               </tr>
               <tr>
                  <td>Number Of Ups</td>
                  <td class="has-input"><input name="numberOfUpsRoll" form="mainForm" id="numberOfUpsRoll" type="number" value="{{ $record->secondary['numberOfUpsRoll'] !== '' ? $record->secondary['numberOfUpsRoll'] : '0' }}" class="blue-field numberOfUpsRoll"></td>
               </tr>
            </tbody>
         </table>
      </div>
      ...
      <div class="table-responsive result-tables sleeve-table"  id="sleeve-table" >
         <table class="table table-bordered myTable">
            ...
            <tbody>
               <tr>
                  <td>Lay Flat (mm)</td>
                  <td class="has-input"><input name="lay-flat-value" form="mainForm" id="lay-flat-value" type="number" value="{{ $record->secondary['lay-flat-value'] !== '' ? $record->secondary['lay-flat-value'] : '0.00' }}" oninput="validateDecimalInput(this)" class="lay-flat-value blue-field"></td>
               </tr>
               <tr>
                  <td>Reel Width (mm)</td>
                  <td class="has-input"><input type="number" form="mainForm" id="real-width-value" name="real-width-value"  value="{{ $record->secondary['real-width-value'] !== '' ? $record->secondary['real-width-value'] : '0.00' }}" oninput="validateDecimalInput(this)" class="real-width-value blue-field"></td>
               </tr>
               <tr>
                  <td>Cut Off (mm)</td>
                  <td class="has-input"><input name="cut-off-value" form="mainForm" id="cut-off-value" type="number" value="{{ $record->secondary['cut-off-value'] !== '' ? $record->secondary['cut-off-value'] : '0.00' }}" oninput="validateDecimalInput(this)" class="cut-off-value blue-field"></td>
               </tr>
               <tr>
                  <td>Extra Printing Trim (mm)</td>
                  <td class="has-input"><input type="number" form="mainForm" name="extra-printing-trim-value" id="extra-printing-trim-value" class="extra-printing-trim-value blue-field " value="{{ $record->secondary['extra-printing-trim-value'] !== '' ? $record->secondary['extra-printing-trim-value'] : '0' }}"></td>
               </tr>
               <tr>
                  <td>Number Of Ups</td>
                  <td class="has-input"><input type="number" form="mainForm" id="number-of-ups-value" name="number-of-ups-value" class="blue-field number-of-ups-value" value="{{ $record->secondary['number-of-ups-value'] !== '' ? $record->secondary['number-of-ups-value'] : '0' }}"></td>
               </tr>
            </tbody>
         </table>
      </div>
            ...
            <table class="table table-bordered myTable">
               ...
               <tbody>
                  <tr>
                     ...
                     <td class="has-input"><input type="number" form="mainForm" name="open-height" id="open-height" oninput="validateDecimalInput(this)" class="open-height blue-field" value="{{ $record->secondary['open-height'] !== '' ? $record->secondary['open-height'] : '0.00' }}"></td>
                  </tr>
                  <tr>
                     <td>Open Width (with Gusset) (mm)</td>
                     <td class="has-input"><input type="number" value="{{ $record->secondary['open-width'] !== '' ? $record->secondary['open-width'] : '0.00' }}" form="mainForm" name="open-width" id="open-width" oninput="validateDecimalInput(this)" class="open-width blue-field"></td>
                  </tr>
                  <tr>
                     <td>Extra Printing Trim (mm)</td>
                     <td class="has-input"><input type="number" form="mainForm" name="extra-printing-trim" id="extra-printing-trim" class="extra-printing-trim blue-field" value="{{ $record->secondary['extra-printing-trim'] !== '' ? $record->secondary['extra-printing-trim'] : '0' }}"></td>
                  </tr>
                  <tr>
                     <td>Number Of Ups</td>
                     <td class="has-input"><input type="number" value="{{ $record->secondary['no_of_ups'] !== '' ? $record->secondary['no_of_ups'] : '0' }}" form="mainForm" name="no_of_ups" id="no_of_ups" class="no_of_ups blue-field"></td>
                  </tr>
               </tbody>
            </table>
         </div>
            ...
            <table class="table table-bordered myTable">
               ...
               <tbody>
                  <tr>
                     ...
                     <td class="has-input"><input type="number" form="mainForm" name="weight-of-one-meter-zip" id="weight-of-one-meter-zip" oninput="validateDecimalInput(this)" class="weight-of-one-meter-zip blue-field" value="{{ $record->secondary['weight-of-one-meter-zip'] !== '' ? $record->secondary['weight-of-one-meter-zip'] : '0.00' }}"></td>
                  </tr>
                  <tr>
                     <td>Cost of 1 Meter Zipper </td>
                     <td class="has-input"><input type="number" form="mainForm" name="cost-one-meter-zipper" id="cost-one-meter-zipper" class="cost-one-meter-zipper blue-field" value="{{ $record->secondary['cost-one-meter-zipper'] !== '' ? $record->secondary['cost-one-meter-zipper'] : '0' }}"></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                     ...
                     <td class="has-input "><input type="number" form="mainForm" name="zipper-weight-per-pouch" id="zipper-weight-per-pouch" oninput="validateDecimalInput(this)" class="zipper-weight-per-pouch" value="{{ $record->secondary['zipper-weight-per-pouch'] !== '' ? $record->secondary['zipper-weight-per-pouch'] : '0.00' }}" readonly></td>
                  </tr>
                  <tr>
                     <td>Zipper Cost per Pouch</td>
                     <td class="has-input "><input type="number" form="mainForm" class="zipper-cost-per-pouch" id="zipper-cost-per-pouch" name="zipper-cost-per-pouch" value="{{ $record->secondary['zipper-cost-per-pouch'] !== '' ? $record->secondary['zipper-cost-per-pouch'] : '0.000' }}" readonly></td>
                  </tr>
                  <tr>
...
<form id="mainForm"  action="{{ route('forms.update', $record->id) }}" method="POST" novalidate>
   @csrf
   @method('PUT')
   <section class="raw-material myTable">
         ...
         <div class="raw-mt-table table-responsive mb-4">
            <table class="table table-bordered text-center" id="materialcosttable">
               ...
               <tbody>
                  ...
                  <tr class="data-row" id="{{$loop->iteration}}">
                     <td class="field-type">
                     ...
                     <td class="field-material">
                        <select class="form-select" id="materialSelect" name="materialSelect[]" data-selected-value="{{ $fields->materialSelect }}">
                           <option value="{{$fields->materialSelect}}" selected>{{$fields->materialSelect}}</option>
                        </select>
                     </td>
                     <td class="field-solid">
                        <div class="have-percent" style="background: #d2edff;border-radius: 6px;"><input type="number" value="{{ $fields->{'solid-input'} }}" name="solid-input[]" class="solid-input form-control blue-field" readonly=""><span>%</span></div>
                     </td>
                     <td class="field-micron"><input type="number" value="{{ $fields->{'micron-input'} }}" name="micron-input[]" class="form-control blue-field micron-input"></td>
                     <td class="field-density"><input type="number" value="{{ $fields->{'density-input'} }}" name="density-input[]" class="form-control density-input" readonly></td>
                     <td class="field-total-gsm"><input type="number" value="{{ $fields->{'total-gsm-input'} }}" name="total-gsm-input[]"   class="form-control total-gsm-input" readonly></td>
                     <td class="field-cost-per-kg"><input type="text" value="{{ $fields->{'cost-per-kg-input'} }}" name="cost-per-kg-input[]" class="form-control blue-field cost-per-kg-input"></td>
                     <td class="field-waste">
                        <div class="have-percent blue-field"><input value="{{ $fields->{'waste-input'} }}" type="number" name="waste-input[]" class="form-control waste-input"><span>%</span></div>
                     </td>
                     <td class="field-cost-m"><input type="text" class="form-control cost-m-input" value="{{ $fields->{'cost-m-input'} }}" name="cost-m-input[]" readonly=""></td>
                     <td class="field-required-kgs-estimated"><input type="text" value="{{ $fields->{'estimated-kg-req-input'} }}" name="estimated-kg-req-input[]"  class="estimated-kg-req-input form-control" readonly></td>
                     <td class="field-lower"><input type="text" name="lower-input[]" value="{{ $fields->{'lower-input'} }}"  class="form-control lower-input layer-input" readonly></td>
                  ...
                  <tr class="data-row">
                     ...
                     <td class="field-solid">
                        <div class="have-percent"><input type="number" name="solid-input[]" class="solid-input form-control blue-field" readonly=""><span>%</span></div>
                     </td>
                     ...
                     <td class="field-waste">
                        <div class="have-percent blue-field"><input type="number" name="waste-input[]" class="form-control waste-input"><span>%</span></div>
                     </td>
            ...
            <tbody>
                ...
                <td class="field-cost-per-kg">
                    <input type="number" name="cost-per-kg-last-value" class="cost-per-kg-last-value form-control blue-field" value="{{ $record->secondary->{'cost-per-kg-last-value'} }}">
                </td>
                ...
                <td class="field-cost-per-kg">
                    <div class="based-ink-res">
                        ...
                        <div class="btm-field">
                            <input type="number" value="{{ $record->secondary->{'total-gsm-last-value'} }}" name="total-gsm-last-value" class="total-gsm-last-value form-control blue-field">
                        </div>
                    </div>
                </td>
                <td class="field-waste"></td>
            ...
            <table class="table table-bordered">
               <tbody>
                  <tr>
                     ...
                     <td class="has-input"><input type="text" readonly name="film-density-input" class="film-density-input" value="{{ $record->secondary->{'film-density-input'} }}"></td>
                     <td><label>Pieces Per Kg</label></td>
                     <td class="has-input"><input class="pieces-per-kg-field" name="pieces-per-kg-field" type="text" value="{{ $record->secondary->{'pieces-per-kg-field'} !=='' ? $record->secondary->{'pieces-per-kg-field'} : '0' }}" readonly></td>
                     <td><label>Printing Film Width (mm)</label></td>
                     <td class="has-input"><input type="text" value="{{ $record->secondary->{'printing-fil-width'} !=='' ? $record->secondary->{'printing-fil-width'} : '0' }}" name="printing-fil-width" class="printing-fil-width" readonly></td>
                  </tr>
                  <tr>
                     ...
                     <td class="has-input"><input type="number" value="{{ $record->secondary->{'grams-per-peice'} !=='' ? $record->secondary->{'grams-per-peice'} : '0.00' }}" name="grams-per-peice" class="grams-per-peice" readonly></td>
                     <td><label>Order Quantity In Kg</label></td>
                     <td class="has-input"><input type="text" name="orderQuantityInKgs" value="{{ $record->secondary->{'orderQuantityInKgs'} !=='' ? $record->secondary->{'orderQuantityInKgs'} : '0.00' }}" readonly class="orderQuantityInKgs"></td>
                  </tr>
                  <tr>
                     <td><label>Total GSM</label></td>
                     <td class="has-input"><input type="number" name="total-gsm-calculated-value" value="{{ $record->secondary->{'total-gsm-calculated-value'} }}" class="total-gsm-calculated-value" readonly></td>
                     <td><label>Square Meter Per Kg</label></td>
                     <td class="has-input"><input class="square-meter-per-kg-input" name="square-meter-per-kg-input" type="text" value="{{ $record->secondary->{'square-meter-per-kg-input'} !=='' ? $record->secondary->{'square-meter-per-kg-input'} : '0.00' }}" readonly></td>
                     <td><label>Order Quantity In Kpieces</label></td>
                     <td class="has-input"><input name="orderQuanInKpieces" type="text" value="{{ $record->secondary->{'orderQuanInKpieces'} !=='' ? $record->secondary->{'orderQuanInKpieces'} : '00,000' }}" class="orderQuanInKpieces" readonly></td>
                  </tr>
                  <tr>
                     <td rowspan="2" style=" vertical-align: middle; "><label>Total Cost /M<sup>2</sup></label></td>
                     <td rowspan="2" style=" vertical-align: middle; " class="has-input"><input type="text" name="total-cost-m-value" class="total-cost-m-value" value="{{ $record->secondary->{'total-cost-m-value'} !=='' ? $record->secondary->{'total-cost-m-value'} : '0.000' }}"  readonly></td>
                     <td><label>Linear Meter Per Kg (Film Width)</label></td>
                     <td class="has-input"><input type="text"  value="{{ $record->secondary->{'linear-meter-per-kg'} !=='' ? $record->secondary->{'linear-meter-per-kg'} : '0.00' }}" name="linear-meter-per-kg" class="linear-meter-per-kg" readonly></td>
                     <td rowspan="2" style=" vertical-align: middle; "><label>Order Quantity In Meter</label></td>
                     <td rowspan="2" style=" vertical-align: middle; "class="has-input"><input type="text" value="{{ $record->secondary->{'OrderQuanInMeter'} !=='' ? $record->secondary->{'OrderQuanInMeter'} : '0.00' }}"  name="OrderQuanInMeter" class="OrderQuanInMeter" readonly></td>
                  </tr>
               ...
               <table class="table table-bordered">
                  <tbody>
                     <tr style="margin-bottom: 20px;">
                        ...
                        <td>
                           <div class="have-percent blue-field"><input type="number" value="{{ $record->secondary['core-inside'] }}" name="core-inside" class="form-control core-inside"><span>mm</span></div>
                        </td>
                     </tr>
                     <tr>
                        <td>If Roll Outside Diameter (With Core)</td>
                        <td>
                           <div class="have-percent blue-field "><input type="number" value="{{ $record->secondary['roll-outside-diameter'] }}" name="roll-outside-diameter" class="form-control roll-outside-diameter"><span>mm</span></div>
                        </td>
                     </tr>
                     <tr>
                        <td>Film On Roll Weight</td>
                        <td>
                           <div class="have-percent grey-bg"><input type="text" value="{{ $record->secondary['film-on-roll-weight'] }}"  class="form-control film-on-roll-weight" name="film-on-roll-weight" readonly><span>kgs</span></div>
                        </td>
                     </tr>
                     <tr>
                        <td>Film On Roll: Length In Meter</td>
                        <td>
                           <div class="have-percent grey-bg"><input type="text" value="{{ $record->secondary['film-on-roll-length'] }}" name="film-on-roll-length" class="form-control film-on-roll-length" readonly><span>Mtr</span></div>
                        </td>
                     </tr>
                     <tr>
                        <td>Roll Width</td>
                        <td>
                           <div class="have-percent grey-bg"><input type="text" value="{{ $record->secondary['roll-width'] }}" name="roll-width" class="form-control roll-width" readonly><span>mm</span></div>
                        </td>
                     </tr>
                     <tr>
                     ...
                     <tr style="margin-top: 20px;">
                        ...
                        <td>
                           <div class="have-percent blue-field"><input type="number" name="required-roll-weight-kg" value="{{ $record->secondary['required-roll-weight-kg'] }}" class="form-control required-roll-weight-kg"><span>kgs</span></div>
                        </td>
                     </tr>
                     <tr>
                        <td>Roll Outside Diameter</td>
                        <td>
                           <div class="have-percent grey-bg"><input type="text" name="core-inside-roll" value="{{ $record->secondary['core-inside-roll'] }}"  class="form-control core-inside-roll" readonly><span>mm</span></div>
                        </td>
                     </tr>
                  </tbody>
               </table>
                  ...
                  <tbody>
                     <tr>
                        <td class="has-checkbox checkbox-field">
                           ...
                           <input type="checkbox" class="form-check-input row-checkbox extrusion-check" name="extrusion-check" {{ ($record->secondary->{'extrusion-check'} == 'on') ? 'checked' : '' }}> 
                           <span class="process-heading">Extrusion</span>
                           </label>
                        </td>
                        <td class="has-input"><input type="text" value="{{ $record->secondary->{'first-speed'} !=='' ? $record->secondary->{'first-speed'} : '700 Kgs/Hr' }}" name="first-speed" class="first-speed blue-field extrusion-speed"></td>
                        <td class="has-input"><input type="text" value="{{ $record->secondary->{'first-setup'} !=='' ? $record->secondary->{'first-setup'} : '0.0' }}" name="first-setup" id="first-setup" class="first-setup blue-field extrusion-setup-hour"></td>
                        <td class="has-input"><input type="text" value="{{ $record->secondary->{'first-hour'} !=='' ? $record->secondary->{'first-hour'} : '0.00' }}" class="first-hour" name="first-hour" readonly></td>
                        <td class="has-input"><input type="number" value="{{ $record->secondary->{'first-process-cost'} !=='' ? $record->secondary->{'first-process-cost'} : '0.0' }}" class="blue-field extrusion-process-cost first-process-cost process-cost-unique" name="first-process-cost"></td>
                        <td class="has-input"><input type="text" value="{{ $record->secondary->{'process-cost-one'} !=='' ? $record->secondary->{'process-cost-one'} : '0' }}" name="process-cost-one" class="process-cost-field process-cost-one" readonly ></td>
                        <td rowspan="10" class="total-cost has-input"><input class="total-process-cost" name="total-process-cost" type="text" value="{{ $record->secondary->{'total-process-cost'} !=='' ? $record->secondary->{'total-process-cost'} : '0' }}" readonly> </td>
                     </tr>
                     <tr>
                        <td class="has-checkbox checkbox-field">
                           <label class="checkbox-label">
                           <input type="checkbox" class="form-check-input row-checkbox printing-check" name="printing-check" {{ ($record->secondary->{'printing-check'} == 'on') ? 'checked' : '' }}>
                           <span class="process-heading">Printing</span>
                           </label>
                        </td>
                        <td class="has-input"><input type="text" id="1s" value="{{ $record->secondary->{'second-speed'} !=='' ? $record->secondary->{'second-speed'} : '250 Mtr/Min' }}" name="second-speed" class="second-speed blue-field printing-speed speed-feild"></td>
                        <td class="has-input"><input type="text" value="{{ $record->secondary->{'second-setup'} !=='' ? $record->secondary->{'second-setup'} : '0.0' }}" name="second-setup" class="second-setup blue-field printing-setup-hour"></td>
                        <td class="has-input"><input type="text" value="{{ $record->secondary->{'second-hour'} !=='' ? $record->secondary->{'second-hour'} : '0.0' }}" name="second-hour" class="second-hour" readonly></td>
                        <td class="has-input"><input type="number" value="{{ $record->secondary->{'second-process-cost'} !=='' ? $record->secondary->{'second-process-cost'} : '0' }}" class="blue-field second-process-cost process-cost-unique" name="second-process-cost"></td>
                        <td class="has-input"><input type="text" name="process-cost-two" class="process-cost-two process-cost-field" value="{{ $record->secondary->{'process-cost-two'} !=='' ? $record->secondary->{'process-cost-two'} : '0' }}" readonly></td>
                     </tr>
                     <tr>
                        <td class="has-checkbox checkbox-field">
                           <label class="checkbox-label">
                           <input type="checkbox" class="form-check-input row-checkbox" name="rewinding-check" {{ ($record->secondary->{'rewinding-check'} == 'on') ? 'checked' : '' }}>
                           <span class="process-heading">rewinding</span>
                           </label>
                        </td>
                        <td class="has-input"><input type="text" id="2s" value="{{ $record->secondary->{'third-speed'} !=='' ? $record->secondary->{'third-speed'} : '500 Mtr/Min' }}" name="third-speed" class="third-speed blue-field rewinding-speed speed-feild"></td>
                        <td class="has-input"><input type="text" name="third-setup" value="{{ $record->secondary->{'third-setup'} !=='' ? $record->secondary->{'third-setup'} : '0.0' }}" class="third-setup blue-field  rewinding-setup-hour update-hour"></td>
                        <td class="has-input"><input type="text" value="{{ $record->secondary->{'third-hour'} !=='' ? $record->secondary->{'third-hour'} : '0.0' }}" name="third-hour" class="third-hour" readonly></td>
                        <td class="has-input"><input type="number" value="{{ $record->secondary->{'third-process-cost'} !=='' ? $record->secondary->{'third-process-cost'} : '0' }}" name="third-process-cost" class="blue-field third-process-cost process-cost-unique"></td>
                        <td class="has-input"><input type="text" value="{{ $record->secondary->{'process-cost-three'} !=='' ? $record->secondary->{'process-cost-three'} : '0' }}" class="process-cost-three process-cost-field" name="process-cost-three" readonly></td>
                     </tr>
                     <tr>
                        <td class="has-checkbox checkbox-field">
                           <label class="checkbox-label">
                           <input type="checkbox" class="form-check-input row-checkbox lamination-1-check" name="lamination-1-check" {{ ($record->secondary->{'lamination-1-check'} == 'on') ? 'checked' : '' }}>
                           <span class="process-heading">lamination 1</span>
                           </label>
                        </td>
                        <td class="has-input"><input type="text" value="{{ $record->secondary->{'fourth-speed'} !=='' ? $record->secondary->{'fourth-speed'} : '200 Mtr/Min' }}" name="fourth-speed" class="fourth-speed blue-field lamination-1-speed speed-feild" ></td>
                        <td class="has-input"><input type="text"  value="{{ $record->secondary->{'fourth-setup'} !=='' ? $record->secondary->{'fourth-setup'} : '0.0' }}" name="fourth-setup" class="fourth-setup blue-field  lamination-1-setup-hour update-hour"></td>
                        <td class="has-input"><input type="text" value="{{ $record->secondary->{'fourth-hour'} !=='' ? $record->secondary->{'fourth-hour'} : '0.0' }}" name="fourth-hour" class="fourth-hour" readonly></td>
                        <td class="has-input"><input type="number" value="{{ $record->secondary->{'fourth-process-cost'} !=='' ? $record->secondary->{'fourth-process-cost'} : '0' }}" name="fourth-process-cost" class="blue-field fourth-process-cost process-cost-unique"></td>
                        <td class="has-input"><input type="text" name="process-cost-four" class="process-cost-four process-cost-field" value="{{ $record->secondary->{'process-cost-four'} !=='' ? $record->secondary->{'process-cost-four'} : '0' }}" readonly></td>
                     </tr>
                     <tr>
                        <td class="has-checkbox checkbox-field">
                           <label class="checkbox-label">
                           <input type="checkbox" class="form-check-input row-checkbox lamination-2-check" name="lamination-2-check" {{ ($record->secondary->{'lamination-2-check'} == 'on') ? 'checked' : '' }}>
                           <span class="process-heading">lamination 2</span>
                           </label>
                        </td>
                        <td class="has-input"><input type="text" value="{{ $record->secondary->{'fifth-speed'} !=='' ? $record->secondary->{'fifth-speed'} : '200 Mtr/Min' }}" name="fifth-speed" class="fifth-speed blue-field lamination-2-speed speed-feild"></td>
                        <td class="has-input"><input type="text" value="{{ $record->secondary->{'fifth-setup'} !=='' ? $record->secondary->{'fifth-setup'} : '0.0' }}" name="fifth-setup" class="fifth-setup lamination-2-setup-hour blue-field update-hour "></td>
                        <td class="has-input"><input type="text" value="{{ $record->secondary->{'fifth-hour'} !=='' ? $record->secondary->{'fifth-hour'} : '0.0' }}" class="fifth-hour" name="fifth-hour" readonly></td>
                        <td class="has-input"><input type="number" value="{{ $record->secondary->{'fifth-process-cost'} !=='' ? $record->secondary->{'fifth-process-cost'} : '0' }}" name="fifth-process-cost" class="blue-field fifth-process-cost process-cost-unique"></td>
                        <td class="has-input"><input type="text" name="process-cost-fifth" class="process-cost-fifth process-cost-field" value="{{ $record->secondary->{'process-cost-fifth'} !=='' ? $record->secondary->{'process-cost-fifth'} : '0' }}" readonly></td>
                     </tr>
                     <tr>
                        <td class="has-checkbox checkbox-field">
                           <label class="checkbox-label">
                           <input type="checkbox" class="form-check-input row-checkbox lamination-3-check" name="lamination-3-check" {{ ($record->secondary->{'lamination-3-check'} == 'on') ? 'checked' : '' }}>
                           <span class="process-heading">lamination 3</span>
                           </label>
                        </td>
                        <td class="has-input"><input type="text" value="{{ $record->secondary->{'six-speed'} !=='' ? $record->secondary->{'six-speed'} : '400 Mtr/Min' }}" name="six-speed" class="six-speed blue-field lamination-3-speed speed-feild"></td>
                        <td class="has-input"><input type="text" value="{{ $record->secondary->{'six-setup'} !=='' ? $record->secondary->{'six-setup'} : '0.0' }}" name="six-setup" class=" six-setup blue-field lamination-3-setup-hour update-hour"></td>
                        <td class="has-input"><input type="text" value="{{ $record->secondary->{'six-hour'} !=='' ? $record->secondary->{'six-hour'} : '0.0' }}" name="six-hour" class="six-hour" readonly></td>
                        <td class="has-input"><input type="number" value="{{ $record->secondary->{'six-process-cost'} !=='' ? $record->secondary->{'six-process-cost'} : '0' }}" name="six-process-cost" class="blue-field six-process-cost process-cost-unique" ></td>
                        <td class="has-input"><input type="text" value="{{ $record->secondary->{'process-cost-six'} !=='' ? $record->secondary->{'process-cost-six'} : '0' }}" class="process-cost-six process-cost-field" name="process-cost-six" readonly></td>
                     </tr>
                     <tr>
                        <td class="has-checkbox checkbox-field">
                        <label class="checkbox-label">
                            <input type="checkbox" class="form-check-input row-checkbox slitting-check" name="slitting-check" {{ ($record->secondary->{'slitting-check'} == 'on') ? 'checked' : '' }}>
                            <span class="process-heading">Slitting</span>
                        </label>
                        </td>
                        <td class="has-input"><input type="text" value="{{ $record->secondary->{'seven-speed'} !=='' ? $record->secondary->{'seven-speed'} : '500 Mtr/Min' }}" name="seven-speed" class="seven-speed blue-field slitting-speed speed-feild"></td>
                        <td class="has-input"><input type="text" value="{{ $record->secondary->{'seven-setup'} !=='' ? $record->secondary->{'seven-setup'} : '0.0' }}" name="seven-setup" class=" seven-setup slitting-setup-hour blue-field update-hour"></td>
                        <td class="has-input"><input type="text" value="{{ $record->secondary->{'seven-hour'} !=='' ? $record->secondary->{'seven-hour'} : '0.0' }}" class="seven-hour" name="seven-hour" readonly></td>
                        <td class="has-input"><input type="number" value="{{ $record->secondary->{'seven-process-cost'} !=='' ? $record->secondary->{'seven-process-cost'} : '0' }}" name="seven-process-cost" class="blue-field seven-process-cost process-cost-unique"></td>
                        <td class="has-input"><input type="text" value="{{ $record->secondary->{'process-cost-seven'} !=='' ? $record->secondary->{'process-cost-seven'} : '0' }}" class="process-cost-seven process-cost-field" name="process-cost-seven" readonly></td>
                     </tr>
                     <tr>
                        <td class="has-checkbox checkbox-field">
                           <label class="checkbox-label">
                           <input type="checkbox" class="form-check-input row-checkbox sleeving-check" name="sleeving-check" {{ ($record->secondary->{'sleeving-check'} == 'on') ? 'checked' : '' }}>
                           <span class="process-heading">Sleeving</span>
                           </label>
                        </td>
                        <td class="has-input"><input type="text" value="{{ $record->secondary->{'eight-speed'} !=='' ? $record->secondary->{'eight-speed'} : '250 Mtr/Min' }}" name="eight-speed" class="eight-speed blue-field sleeving-speed speed-feild"></td>
                        <td class="has-input"><input type="text" value="{{ $record->secondary->{'eight-setup'} !=='' ? $record->secondary->{'eight-setup'} : '0.0' }}" name="eight-setup" class=" eight-setup sleeving-setup-hour blue-field update-hour"></td>
                        <td class="has-input"><input type="text" value="{{ $record->secondary->{'eight-hour'} !=='' ? $record->secondary->{'eight-hour'} : '0.0' }}" class="eight-hour" name="eight-hour" readonly></td>
                        <td class="has-input"><input type="text" value="{{ $record->secondary->{'eight-process-cost'} !=='' ? $record->secondary->{'eight-process-cost'} : '0.0' }}" name="eight-process-cost" class="blue-field eight-process-cost process-cost-unique"></td>
                        <td class="has-input"><input type="text" value="{{ $record->secondary->{'process-cost-eight'} !=='' ? $record->secondary->{'process-cost-eight'} : '0' }}" class="process-cost-eight process-cost-field" name="process-cost-eight" readonly></td>
                     </tr>
                     <tr>
                        <td class="has-checkbox checkbox-field">
                           <label class="checkbox-label">
                           <input type="checkbox" class="form-check-input row-checkbox doctoring-check" name="doctoring-check" {{ ($record->secondary->{'doctoring-check'} == 'on') ? 'checked' : '' }}>
                           <span class="process-heading">Sleeve Doctoring</span>
                           </label>
                        </td>
                        <td class="has-input"><input type="text" value="{{ $record->secondary->{'nine-speed'} !=='' ? $record->secondary->{'eight-speed'} : '000 Mtr/Min' }}" name="nine-speed" class="nine-speed blue-field speed-feild doctoring-speed"></td>
                        <td class="has-input"><input type="text" value="{{ $record->secondary->{'nine-setup'} !=='' ? $record->secondary->{'nine-setup'} : '0.0' }}" name="nine-setup" class="nine-setup blue-field update-hour doctoring-setup-hour"></td>
                        <td class="has-input"><input type="text" value="{{ $record->secondary->{'nine-hour'} !=='' ? $record->secondary->{'nine-hour'} : '0.0' }}" class="nine-hour" name="nine-hour" readonly></td>
                        <td class="has-input"><input type="number" value="{{ $record->secondary->{'nine-process-cost'} !=='' ? $record->secondary->{'nine-process-cost'} : '0' }}" name="nine-process-cost" class="blue-field nine-process-cost process-cost-unique"></td>
                        <td class="has-input"><input type="text" name="process-cost-nine" class="process-cost-nine process-cost-field" value="{{ $record->secondary->{'process-cost-nine'} !=='' ? $record->secondary->{'process-cost-nine'} : '0.00' }}" readonly></td>
                     </tr>
                    <tr>
                        <td class="has-checkbox checkbox-field">
                        <label class="checkbox-label">
                            <input type="checkbox" class="form-check-input row-checkbox pouch-making-check" name="pouch-making-check" {{ ($record->secondary->{'pouch-making-check'} == 'on') ? 'checked' : '' }}>
                            <span class="process-heading">Pouch Making</span>
                        </label>
                        </td>
                        <td class="has-input"><input type="text" value="{{ $record->secondary->{'ten-speed'} !=='' ? $record->secondary->{'ten-speed'} : '0 Pcs/Min' }}" name="ten-speed" class="ten-speed blue-field pouch-speed-feild pouch-speed"></td>
                        <td class="has-input"><input type="text" value="{{ $record->secondary->{'ten-setup'} !=='' ? $record->secondary->{'ten-setup'} : '0.0' }}" name="ten-setup" class="ten-setup blue-field update-hour doctoring-setup-hour "></td>
                        <td class="has-input"><input type="text" value="{{ $record->secondary->{'ten-hour'} !=='' ? $record->secondary->{'ten-hour'} : '0.0' }}" class="ten-hour" name="ten-hour" readonly></td>
                        <td class="has-input"><input type="number" value="{{ $record->secondary->{'ten-process-cost'} !=='' ? $record->secondary->{'ten-process-cost'} : '0' }}" name="ten-process-cost" class="blue-field ten-process-cost process-cost-unique"></td>
                        <td class="has-input"><input type="text" name="process-cost-ten" class="process-cost-ten process-cost-field" value="{{ $record->secondary->{'process-cost-ten'} !=='' ? $record->secondary->{'process-cost-ten'} : '0' }}" readonly></td>
                    </tr>
                    <tr style="border: 0;">
                        ...
                        <td class="has-input" style="border: 0;"><input class="opearion-cost-per-kg" id="opearion-cost-per-kg" name="opearion-cost-per-kg" type="number" value="{{ $record->secondary->{'opearion-cost-per-kg'} !=='' ? $record->secondary->{'opearion-cost-per-kg'} : '0.00' }}" readonly> </td>
                    </tr>
                  </tbody>
               </table>
            </div>
               ...
               <table class="table table-bordered align-middle">
                  <thead>
                     <tr>
                        ...
                        <th class="th-has-tag"><span>Markup</span><input type="number" class="markupPercent blue-field" name="markupPercent" value="{{ $record->secondary->{'markupPercent'} !=='' ? $record->secondary->{'markupPercent'} : '0' }}">%</th>
                  ...
                  <tbody>
                     <tr>
                        ...
                        <td class="has-input"><input type="number" value="{{ $record->secondary->{'first-per-kg-value'} !=='' ? $record->secondary->{'first-per-kg-value'} : '0.0000' }}" name="first-per-kg-value" class="per-kg-field" readonly></td>
                        <td class="has-input"><input type="number" value="{{ $record->secondary->{'second-per-kg-value'} !=='' ? $record->secondary->{'second-per-kg-value'} : '0.00' }}" name="second-per-kg-value" class="second-per-kg-value" readonly></td>
                        <td class="has-input"><input type="number" value="{{ $record->secondary->{'third-per-kg-value'} !=='' ? $record->secondary->{'third-per-kg-value'} : '0.00' }}" name="third-per-kg-value" class="third-per-kg-value blue-field"></td>
                        <td class="has-input"><input type="number" value="{{ $record->secondary->{'fourth-per-kg'} !=='' ? $record->secondary->{'fourth-per-kg'} : '0.00' }}" name="fourth-per-kg" class="fourth-per-kg blue-field"></td>
                        <td class="has-input"><input type="number" value="{{ $record->secondary->{'fifth-per-kg'} ?? '0.00' }}"name="fifth-per-kg" class="blue-field fifth-per-kg"></td>
                        <td class="has-input"><input type="number" value="{{ $record->secondary->{'six-kg'} !=='' ? $record->secondary->{'six-kg'} : '0.00' }}" name="six-kg" class="blue-field six-kg" readonly></td>
                     </tr>
                     <tr>
                        <td class="has-label"><label>per kpcs</label></td>
                        <td class="has-input"><input type="number" value="{{ $record->secondary->{'perKpcsFirst'} !=='' ? $record->secondary->{'perKpcsFirst'} : '0.00' }}" name="perKpcsFirst" class="perKpcs" readonly></td>
                        <td class="has-input"><input type="number" value="{{ $record->secondary->{'perKpcsSecond'} !=='' ? $record->secondary->{'perKpcsSecond'} : '0.00' }}" name="perKpcsSecond" class="perKpcsSecond" readonly></td>
                        <td class="has-input"><input type="number" value="{{ $record->secondary->{'perKpcsthird'} !=='' ? $record->secondary->{'perKpcsthird'} : '0.00' }}" name="perKpcsthird" class="perKpcsthird" readonly></td>
                        <td class="has-input"><input type="number" value="{{ $record->secondary->{'perkpcsfourth'} !=='' ? $record->secondary->{'perkpcsfourth'} : '0.00' }}" name="perkpcsfourth" class="perkpcsfourth" readonly></td>
                        <td class="has-input"><input type="number" value="{{ $record->secondary->{'fifth-kpcs'} !=='' ? $record->secondary->{'fifth-kpcs'} : '0.00' }}" name="fifth-kpcs" class="fifth-kpcs" readonly></td>
                        <td class="has-input"><input type="number" value="{{ $record->secondary->{'six-kpcs'} !=='' ? $record->secondary->{'six-kpcs'} : '0.00' }}" name="six-kpcs" class="blue-field six-kpcs" readonly></td>
                     </tr>
                     <tr>
                        <td class="has-label"><label>per SQM</label></td>
                        <td class="has-input"><input class="per-sqm-field" name="FirstPerSqm" type="number" value="{{ $record->secondary->{'FirstPerSqm'} !=='' ? $record->secondary->{'FirstPerSqm'} : '0.00' }}" readonly></td>
                        <td class="has-input"><input type="number" value="{{ $record->secondary->{'secondPerSqm'} !=='' ? $record->secondary->{'secondPerSqm'} : '0.0000' }}" class="secondPerSqm" name="secondPerSqm" readonly></td>
                        <td class="has-input"><input type="number" value="{{ $record->secondary->{'ThirdPerSqm'} !=='' ? $record->secondary->{'ThirdPerSqm'} : '0.0000' }}" class="ThirdPerSqm" name="ThirdPerSqm" readonly></td>
                        <td class="has-input"><input type="number" value="{{ $record->secondary->{'fourthPerSqm'} !=='' ? $record->secondary->{'fourthPerSqm'} : '0.0000' }}" name="fourthPerSqm" class="fourthPerSqm" readonly></td>
                        <td class="has-input"><input type="number" value="{{ $record->secondary->{'fifth-sqm'} !=='' ? $record->secondary->{'fifth-sqm'} : '0.0000' }}" class="fifth-sqm" name="fifth-sqm" readonly></td>
                        <td class="has-input"><input type="number" value="{{ $record->secondary->{'six-sqm'} !=='' ? $record->secondary->{'six-sqm'} : '0.0000' }}" name="six-sqm" class="six-sqm blue-field" readonly></td>
                     </tr>
                    <tr>
                        <td class="has-label"><label>per LM</label></td>
                        <td class="has-input"><input type="number" name="perLmValue" value="{{ $record->secondary->{'perLmValue'} !=='' ? $record->secondary->{'perLmValue'} : '0.0000' }}" class="perLmValue" readonly></td>
                        <td class="has-input"><input type="number" value="{{ $record->secondary->{'secondPerLM'} !=='' ? $record->secondary->{'secondPerLM'} : '0.0000' }}" class="secondPerLM" name="secondPerLM" readonly></td>
                        <td class="has-input"><input type="number" value="{{ $record->secondary->{'thirdPerLM'} !=='' ? $record->secondary->{'thirdPerLM'} : '0.0000' }}" name="thirdPerLM" class="thirdPerLM" readonly></td>
                        <td class="has-input"><input type="number" value="{{ $record->secondary->{'fourthLm'} !=='' ? $record->secondary->{'fourthLm'} : '0.0000' }}" name="fourthLm" class="fourthLm" readonly></td>
                        <td class="has-input"><input type="number" value="{{ $record->secondary->{'fifth-lm'} !=='' ? $record->secondary->{'fifth-lm'} : '0.0000' }}" class="fifth-lm" name="fifth-lm" readonly></td>
                        <td class="has-input"><input type="number" value="{{ $record->secondary->{'six-lm'} !=='' ? $record->secondary->{'six-lm'} : '0.0000' }}" class="blue-field six-lm" name="six-lm" readonly></td>
                    </tr>
                    <tr>
            ...
            <table class="table table2 table-responsive" style="border-color: transparent;border-bottom: 0;">
                    ...
                    <tr>
                        <td style="font-weight: 400;border: 1px solid #dee2e6;border-top: 0;">
                            <div class="have-percent blue-field"><input type="text" value="{{ $record->secondary->{'final-output'} ?? '0' }}" name="final-output" class="final-output" style="min-"><span>Kgs</span></div>
                        </td>
                        <td style="width: 90%;border-bottom: 0;"></td>
                    </tr>
                </tbody>
    ...
    <div class="oc-table total-cost pb-5 actual-table graphTable">
            <div class="cont">
                <div class="table-responsive">
                    <table class="table table-bordered align-middle new-table" id="graphTable">
                        ...
                        <tr id="lower-row-{{$fields->row_id}}">
                            ...
                            <td><input type="text" value="{{ $fields->{'actual-consumption'}  }}" id="{{$fields->row_id}}" name="actual-consumption[]" class="actual-consumption blue-field"></td>
                            ...
                            <td hidden><input class="hidden-field-value" name="hidden-field-value[]" value="{{ $fields->{'hidden-field-value'}  }}" hidden></td>
                        </tr>
                        @endforeach
                        @endif
                        <tr>
                ...
                <table class="table table-bordered align-middle new-table" style="margin-top: -70px;z-index: -1;position: relative;">
                        ...
                        <tr>
                            ...
                            <td style="border-top: 1px solid #dee2e6 !important;"><input type="text" name="last-total-amount-one" class="last-total-amount-one" value="{{ $record->secondary->{'last-total-amount-one'} ?? '0' }}" style="text-align:center !important;font-weight: 600;" readonly></td>
                        </tr>
                        <tr>
                            ...
                            <td><input type="number" value="{{ $record->secondary->{'actual-raw-material-cost-one'} ?? '0' }}" class="actual-raw-material-cost-one" name="actual-raw-material-cost-one" style="text-align:center !important;font-weight: 600;" readonly></td>
                        </tr>
                        <tr>
                            <td colspan="3" style="text-align:right !important;color: #1363a6;font-weight: 600;"><label>Difference ---></label></td>
                            <td style="overflow:hidden;"><div class="have-percent" style="justify-content: center;color: #000 !important;padding-right:0;"><input type="number" value="{{ $record->secondary->{'last-difference-one'} ?? '0' }}" name="last-difference-one" class="last-difference-one"  style="color: #000 !important;width: 100px;font-weight: 600;margin-left: -50px;" readonly><span>%</span></div></td>
                        </tr>
                    </tbody>
                </table>
            </div>
        ...
        <div class="last-div total-cost mt-5">
        <div class="table-responsive">
            <table class="table table-bordered align-middle txt-center" id="lowerTable">
                <thead>
                <tr>
                    <th>Processes</th>
                    <th>Actual Hours</th>
                ...
                <tr data-process="{{ $fields->{'process-name'} }}">
                    ...
                    <td class="has-input"><input type="number" value="{{ $fields->{'actual-hours'} }}" name="actual-hours[]" class="blue-field actual-hours"></td>
            ...
            <table class="table table-bordered align-middle new-table" style="margin-top: -70px;z-index: -1;position: relative;">
                    ...
                    <tr>
                        <td style="border-top: 1px solid #dee2e6 !important;" colspan="3"><label></label></td>
                        <td style="border-top: 1px solid #dee2e6 !important;"><input style="font-weight: 600;" type="text" name="last-total-amount-two" class="last-total-amount-two" value="{{ $record->secondary->{'last-total-amount-two'} ?? '0' }}" readonly></td>
                    </tr>
                    <tr>
                        <td colspan="3" style="text-align:right !important;color: #1363a6;font-weight: 600;"><label>Actual Operation Cost Per Kg ---></label></td>
                        <td><input type="number" value="{{ $record->secondary->{'actual-raw-material-cost-two'} ?? '0.00' }}" class="actual-raw-material-cost-two" name="actual-raw-material-cost-two" style="text-align:center !important;font-weight: 600;" readonly></td>
                    </tr>
                    <tr>
                        <td colspan="3" style="text-align:right !important;color: #1363a6;font-weight: 600;"><label>Difference ---></label></td>
                        <td style="overflow:hidden;"><div class="have-percent" style="justify-content: center;color: #000 !important;padding-right:0;"><input type="number" value="{{ $record->secondary->{'last-difference-two'} ?? '0.00' }}" name="last-difference-two" class="last-difference-two" style="color: #000 !important;width: 100px;font-weight: 600;margin-left: -50px;" readonly><span>%</span></div></td>
                    </tr>
                </tbody>
            </table>
        ...
        <div class="table-responsive">
            <table class="table-bordered table" style="max-width: 500px;margin: 0 auto 3rem;">
                <thead>
                    ...
                    <td style="border: 1px solid #dee2e6; background: #d2edff;text-align: center;"><input type="number" name="lastSalesPrice" class="lastSalesPrice" value="{{ $record->secondary->lastSalesPrice ?? '0.00' }}" style="background: #d2edff;"></td>
                </thead>
            </table>
        </div>
            ...
            <div class="table-responsive">
                <table class="table-bordered table" style="max-width: 995px;margin: 0 auto;">
                    ...
                    <tbody>
                        <tr>
                            <td>
                                    <textarea name="remarks" style="text-align: center !important; width: 100%;" rows="10" >{{ $record->secondary->remarks ?? '' }}</textarea>
                            </td>
                        </tr>
                    </tbody>
                </table>
...
<script>
 document.addEventListener('DOMContentLoaded', function () {
    Chart.register(ChartDataLabels);
       ...
       // Store Laravel Blade values when the page loads
    const perSqmInput = document.querySelector(".six-kg");
    const lastSalesInput = document.querySelector(".lastSalesPrice");

    if (perSqmInput) {
        perSqmInput.dataset.initialValue = perSqmInput.value; // Store Blade value
    }
    if (lastSalesInput) {
        lastSalesInput.dataset.initialValue = lastSalesInput.value; // Store Blade value
    }
...
initializeChart();
        ...
        // Get the initial product type from the server-side variable
        const productType = "{{ $record->productType }}";  // Assuming $record->productType is being passed to the Blade view
        ...
        // Show the appropriate table based on the initial value of productType
        if (productType === 'roll') {
        ...
        // Add event listener to handle changes in product type
...
initializesecondChart();
  ...
  function setInputValues(row, material) {
   ...
   function calculateTotalGSM(micronInputElement) {
    ...
    const WastP = row.querySelector(".waste-input").value;
...
//     // Ensure it's a valid number and format it to two decimal places
//     if (value && !isNaN(value)) {
//         // Convert to number and fix it to two decimal places
//         value = parseFloat(value).toFixed(2);
//         event.target.value = value;
//     } else if (value === "") {
//         // If the field is empty, reset the value to 0.00
//         event.target.value = "0.00";
//     }
// }

// // Add event listeners to the input fields
// document.querySelector(".roll-real-width").addEventListener("input", formatDecimalInput);
// document.querySelector(".roll-cut-off").addEventListener("input", formatDecimalInput);
...
function calculatePrintingFilWidth() {
    ...
    document.querySelector(".printing-fil-width").value = printingFilWidth.toLocaleString();
    calculateLinearMeterPerKg();
}
...
function calculateFifthHour() {
    ...
    let OrderQuanInMeter = parseFloat(document.querySelector(".OrderQuanInMeter")?.value.replace(/,/g, '')) || 0;
...
function calculateCostOneMeterZipper() {
  ...
  var rollWidthValue = 0;
    ...
    filmOnRoll = parseFloat(document.querySelector('.cost-one-meter-zipper').value) || 0;
  ...
  // Update the value of the roll-width input field
  document.querySelector('.cost-one-gr-zipper').value = rollWidthValue.toFixed(3); // You can adjust the decimal places if needed
...
function appendOrUpdateRowToLowerTable(rowId) {
    ...
    document.querySelectorAll(".field-material select").forEach(function(materialSelect) {
        materialSelect.addEventListener("change", function() {
            const rowId = materialSelect.closest("tr").id; // Directly getting the rowId
            appendOrUpdateRowToLowerTable(rowId); // Pass the correct rowId to append or update the lower table row
        });
    });
  ...
  function updateLowerTable(event) {
    ...
    function calculateRawMaterialCostTwo() {
        ...
        const lastTotalAmount = parseFloat(document.querySelector('.last-total-amount-two').value.replace(/,/g, '')) || 0;
        const finalOutput = parseFloat(document.querySelector('.final-output').value.replace(/,/g, '')) || 0;
