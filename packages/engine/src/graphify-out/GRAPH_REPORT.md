# Graph Report - apps\estimation-studio\packages\engine\src  (2026-06-29)

## Corpus Check
- 30 files · ~21,084 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 162 nodes · 361 edges · 10 communities
...
Cohesion: 0.21
Nodes (14): calculateEstimate(), calculatePrintingWebWidth(), calculateProcessCosts(), calculateProductMetrics(), calculateSalePrice(), calculatePouchAccessories(), calculateStructureDensity(), calculateSubstrateGaugeMicron() (+6 more)
...
Cohesion: 0.19
Nodes (11): LaminationRecipe, EMPTY, PouchAccessoryKind, PouchAccessoryResult, PouchAccessorySelection, noMaterials, EstimateDimensions, Material (+3 more)
...
## Knowledge Gaps
- **46 isolated node(s):** `BagConfiguratorType`, `BagFlatSheetResult`, `BAG_SUBTYPE_VALUES`, `hpBinder`, `materials` (+41 more)
  These have ≤1 connection - possible missing edges or undocumented components.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Material` connect `Community 7` to `Community 0`, `Community 1`, `Community 3`, `Community 4`, `Community 6`?**
...
- **Why does `calculateEstimate()` connect `Community 1` to `Community 8`, `Community 3`, `Community 6`?**
