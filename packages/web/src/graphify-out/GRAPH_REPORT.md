...
## Corpus Check
- 121 files · ~115,938 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 880 nodes · 1934 edges · 46 communities (45 shown, 1 thin omitted)
...
9. `buildCustomSlabPrice()` - 11 edges
10. `ThemeId` - 11 edges
...
Cohesion: 0.10
Nodes (13): CustomerAutocompleteProps, CustomerOption, EmptyStateProps, NewQuoteDialog(), NewQuoteDialogProps, RepeatOrderCustomerDialog(), RepeatOrderCustomerDialogProps, SectionTitle() (+5 more)
...
Cohesion: 0.12
Nodes (19): cormDisplayPerKgToEngineUsd(), displayToUsd(), formatPrice(), roundUsd(), usdToDisplay(), CategoryNode, DEFAULT_SUBSTRATE_FAMILIES, deriveSubstrateFamilies() (+11 more)

### Community 6 - "Community 6"
Cohesion: 0.16
Nodes (17): TemplateBuilder(), useMaterialsContextOptional(), structureTierLabel(), cardMetaLine(), catalogInput(), classificationContext(), classificationTag(), _MATERIAL_CLASS_OPTIONS (+9 more)
...
Cohesion: 0.10
Nodes (25): AccessoryMaterialOption, POUCH_TYPE_LABEL, PouchConfigurator(), selectOnFocus(), accessoriesForPouchType(), ACCESSORY_APPLICABILITY, canonicalPouchSubtype(), LEGACY_POUCH_SUBTYPE_ALIASES (+17 more)

### Community 15 - "Community 15"
Cohesion: 0.08
Nodes (21): API_BASE_URL, PlatformMasterMaterialInput, PlatformMasterMaterialRow, PlatformReferenceCategory, PlatformReferenceItemInput, PlatformTemplateSync, TenantSyncResult, UnitBasis (+13 more)

### Community 16 - "Community 16"
Cohesion: 0.16
Nodes (14): PlatformAdminRoute(), ProtectedRoute(), useAuth(), MaterialListItem, MaterialsContext, MaterialsContextValue, MaterialsProvider(), useEntrance() (+6 more)
...
Cohesion: 0.14
Nodes (13): ConfirmDialog(), ConfirmDialogProps, CustomerFormDialog(), CustomerFormDialogProps, CustomerFormValues, emptyForm, UseEntranceOptions, UseEntranceResult (+5 more)
...
Cohesion: 0.06
Nodes (34): CombinedPriceListPanel(), PriceListRow, Props, DuplicateEstimateDialog(), Props, Props, ESTIMATE_STATUS_FILTERS, EstimateStatus (+26 more)
...
Cohesion: 0.14
Nodes (18): isExwDelivery(), JobHeaderFields(), MasterDataContext, MasterDataContextValue, MasterDataProvider(), useMasterDataContextOptional(), useMasterDataReference(), DEFAULT_MASTER_REFERENCE (+10 more)

### Community 35 - "Community 35"
Cohesion: 0.09
Nodes (26): EstimateProcessesPanel(), EstimateProcessRow, Props, FilmStackVisualizer(), LayerCard(), LayerCardLayer, LayerCardProps, GradeOption (+18 more)
...
## Knowledge Gaps
- **196 isolated node(s):** `Band`, `Panel`, `ExtraPiece`, `DRAWERS`, `BottomSheetProps` (+191 more)
...
- **Why does `ApiClient` connect `Community 0` to `Community 1`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 12`, `Community 15`, `Community 16`, `Community 21`, `Community 23`, `Community 25`, `Community 26`, `Community 27`, `Community 32`, `Community 34`, `Community 35`, `Community 40`, `Community 46`, `Community 48`, `Community 49`, `Community 50`?**
  _High betweenness centrality (0.252) - this node is a cross-community bridge._
- **Why does `useAuth()` connect `Community 16` to `Community 32`, `Community 1`, `Community 34`, `Community 35`, `Community 4`, `Community 6`, `Community 42`, `Community 15`, `Community 23`, `Community 25`, `Community 27`?**
